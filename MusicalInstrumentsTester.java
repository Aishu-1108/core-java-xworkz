class MusicalInstrumentsTester{
  ...
  public static void main(String args[]){
   ...
   MusicalInstruments instrument = new MusicalInstruments("Piano","Chordophones","Black",5000);
   ...
   MusicalInstruments instrument1 = new MusicalInstruments("Guitar","Stringed instrument","Red color",6000);
   ...
   MusicalInstruments instrument2 = new MusicalInstruments("Saxophone","wind instrument","Golden color",7000);
   ...
   MusicalInstruments instrument3 = new MusicalInstruments("Violin","Stringed instrument","Mustard color",5000);
   ...
   MusicalInstruments instrument4 = new MusicalInstruments("Clarinet","Wind instrument","Silver color",15000);
   ...
   MusicalInstruments instrument5 = new MusicalInstruments( "Xylophone","percussion instrument","brown",3000);
   ...
   MusicalInstruments instrument6 = new MusicalInstruments("Electronic keyboard","Chordophones","white",7000);
   ...
   MusicalInstruments instrument7 = new MusicalInstruments("Accordion","Chordophones","Red",5000);
   ...
   MusicalInstruments instrument8 = new MusicalInstruments("FLute","wind instrument","Yellow",1000);
   ...
   MusicalInstruments instrument9 = new MusicalInstruments("Tuba","Wind instrument","Golden",10000);
