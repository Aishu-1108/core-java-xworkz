        ...
        do{
            ...
            switch (options){
                ...
                case 3: System.out.println("Fetching book names by year");
                        BookDTO[] book2 = lib.getBookByYear(sc.nextInt());
                ...
                case 8: System.out.println("Fetching book name by year of publish");
                        String[] bookName1 = lib.getBookNamesByYearOfPublish(sc.nextInt());
                        System.out.println("The book name is: "+ Arrays.toString(bookName1));
                        break;
