...
static String kannadaMovies[] = {"Raaghu","K.G.F chapter1","K.G.F chapter2","Dr56","Love Birds","Ravi Bopanna","Triple Riding","Vaarasdara"," Garuda","Dia",
...
static String hindiMovies[] = {"Pathaan","Baskasuran","Ram Setu","Thank God","Dada","Shershaah","3 Idiots","Tumbbad","Runway 34","JugJugg Jeeyo","Padmaavat",
"Sulthan","Raazi","Ki & Ka","Jab we met","Dhoom2","War","Welcome","Kalank","vivah","good newwz","Befikre","Raabta","Gully Boy","Kesari"};

static String teluguMovies[] = {"V","Custody","Sita Ramam","Puli","Maharshi","Oh my darling","Acharya","Giri","Neetho","Hit","Fidaa",
"Jaanu","VIP 2","Athadu","goodchari","Jai Bhim","Evaru","Nota","Majili","Mismatch","F2","Aame","Black","Saaho","Paagal "};

static String englishMovies[] = {"after","My Fault","AIR","The Boss Baby","Smile","Fall","X","Fortress 1","Creed","KING","Creed 2",
"COMA","Sayen","King Kong","Shrek","Rocky","Overdose","Die Hart","Deep Water","Nikita","Venom","Room 203","The Lair","Top Gun","Sista"};

static String malayalamMovies[] = {"AYISHA","Kaduva","Kooman","Kotthu","Varayan","#Home","4 years","Jo&Jo","Malik","The Priest","Mike",
