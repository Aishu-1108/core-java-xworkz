class BookTester{
  ...
  Books book = new Books("MEDITATIONS","MIND & BODY","MARCUS ANNIUS ARELIUS",140);
  ...
  Books book1 = new Books("The secret garden","novel","Frances hodgson burnett",181);
  ...
  Books book2 = new Books("THE GUIDE","NOVEL","R K NARAYAN",150);
  ...
  Books book3 = new Books("MALGUDI DAYS","FICTIONAL STORY","RK NARAYAN",184);
  ...
  Books book4 = new Books("THE PRIVATE LIFE OF AN INDIAN PRINCE","NOVEL","MULK RAJ",295);
  ...
  Books book5 = new Books("TRAIN TO PAKISTAN","HISTORY","KHUSHWANT SINGH",182);
  ...
  Books book6 = new Books("GODAN","SOCIO-ECONOMIC DEPRIVATION","MUNSHI PREMCHAND",110);
  /*book6.name = "GODAN";
  ...
  Books book7 = new Books("THE ROOM ON THE ROOF","NOVAL","RUSKIN BOND",174);
  ...
  Books book8 = new Books("THE COMPLETE ADVENTURES OF FELUDA","HISTORY","SATYAJIT RAY",280);
  ...
  Books book9 = new Books("THE AUTOBIOGRAPHY OF AN UNKNOWN INDIAN","AUTOBIOGRAPHY","NIRAD C CHAUDHURI",280);
