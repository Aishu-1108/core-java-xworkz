class HotelShangriLa{
 //50 items
 static String foodMenus[] = {"Chhole","Pav Bhaji","Mix Veg","Channa Masala","Corn Capsicum","Green Garden","Paneer Bhurji","Panner Butter masala",
 ...
 //foreach 
  System.out.println("List of menu are");
