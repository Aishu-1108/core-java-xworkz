...
public static void main(String suite[]){
 ...
 SuitCase suitCase = new SuitCase("Delsey","5kg",5000,3);
 ...
 SuitCase suitCase1 = new SuitCase("American Tourister","7kg",7000,5);
 ...
 SuitCase suitCase2 = new SuitCase("Wildcraft","8kg",8000,6);
 ...
 SuitCase suitCase8 = new SuitCase("Calpak","6kg",10000,5);
 ...
 SuitCase suitCase9 = new SuitCase("Travelpro","4kg",10000,5);
